<x-app-layout>
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="{{ route('submission.index') }}" class="inline-flex items-center mb-4 text-gray-600 hover:text-gray-900">
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg">
                            ...
                            @php
                                ...
                                if ($userRole === 'General Affair') {
                                    ...
                                    $extraDepts = ['CHRD', 'Finance', 'General Affair'];
                                } elseif ($userRole === 'COO') {
                                    $extraDepts = ['COO', 'CHRD', 'Finance', 'General Affair'];
                                } else {
                                    $extraDepts = [];
                                }
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2" x-data="{ count: 0 }" x-init="count = $refs.content.value.length">
                                    ...
                                    <textarea x-ref="content" @input="count = $event.target.value.length" id="deskripsi_barang" name="deskripsi_barang" rows="3" maxlength="500" class="mt-1 block w-full border-gray-300 ..."></textarea>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg">
                            ...
                            <div class="space-y-6">
                                ...
                                <div x-data="{ count: 0 }" x-init="count = $refs.content.value.length">
                                    ...
                                    <textarea x-ref="content" @input="count = $event.target.value.length" id="deskripsi_pengadaan" name="deskripsi_pengadaan" rows="4" maxlength="500" class="mt-1 block w-full border-gray-300 ..."></textarea>
                                    <div class="text-sm text-gray-500 mt-1 text-right" :class="{ 'text-red-500': count > 500 }">
                                        <span x-text="count"></span> / 500
                                    </div>
                                </div>
